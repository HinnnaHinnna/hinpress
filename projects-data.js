...
const rawProjects = [
  {
    ...
    size: ['185x255mm', '72p'],
    description:
      '본 책은 매체를 주요 소재로 삼아 ‘쓰기’라는 행위를 디자인에 대입해 사고의 전환을 시도하고, 코드를 매개로 한 새로운 커뮤니케이션 방식을 탐구한 연구의 기록이다. 표지의 배경색은 전통적인 쓰기를 상징하는 연필 흑심, 표지 위에 선택적으로 유광 처리된 부분은 휴대전화 화면의 블랙 미러로서 매체를 상징한다.',

...
const rawProjects = [
  ...
  },
  {
    ...
    size: ['125x130mm', '296p'],
    description:
      '일본 전통 공연인 라쿠고 &lt;심안&gt; 원문과 그 라쿠고를 리메이크한 일본 드라마 &lt;심안&gt; 자막으로 구성된 책이다. 등장인물은 총 4명이다. 표지 앞면은 3명의 등장 인물에 지정한 색을 그라데이션으로, 표지 뒷면은 장님인 주인공을 나타내는 검은색을 단면으로 표현했다. 이는 내지의 등장 인물 대사와 연결된다. 왼쪽 면은 주인공 한 명의 대사만, 오른쪽 면은 나머지 3명의 대사만이 나온다. 내지는 구조적으로 상하 구분되었다. 상단은 &lt;심안&gt;의 1930년대 최초 원문이, 하단은 드라마의 자막이 흐른다. 어떤 방식으로 읽든 독자의 영역이다. ',
    category: 'Graphic Design',

...
const rawProjects = [
  ...
  {
    id: 8,
    title: 'Capital Fortifications of Hanyang',
    subtitle: ['보고서'],
    year: '2023-',
  ...
  },
  {
    ...
    year: '2025',
    description:
      '한국타이포그라피협회 전시 19 《그리드쉬프트》 출품 작업. &lt;U+1D177 : 슬러의 대모험&gt;은 둘 이상의 대상을 대등하게 이어 주는 접속 조사 “~와”와 동일한 의미인 단어들를 조합해 만든 단 하나의 글자이다. 작업의 소재로 접속 조사 “와”를 사용한 이유는 글자들의 전시이자, 문장, 음률인 《그리드쉬프트》 속에서 다른 작업을 대등하게 이어주는 조사의 역할을 의도했기 때문이다.',
    category: 'Graphic Design',
    client: ['한국타이포그라피협회'],
